				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2" id="navbar">
							<h1 class="to-animate"><a href="#" data-nav-section="menu">Main Course Menu</a></h1>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="fh5co-testimonials" data-section="menu">
		...
		<div class="container">
			<div class="row">
				<?php
					include 'connect.php';
					$query = mysql_query("SELECT *, course.id as idc, course.name as namec FROM course INNER JOIN chef ON course.chef=chef.id AND course.category='main'");
