				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2" id="navbar">
							<h1 class="to-animate"><a href="#" data-nav-section="menu">Vegetarian Main Menu</a></h1>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="fh5co-testimonials" data-section="menu">
		...
		<div class="container">
			<div class="row">
				<?php
					include 'connect.php';
					$query = mysql_query("SELECT *, course.id as idc, course.name as namec FROM course INNER JOIN chef ON course.chef=chef.id AND course.category='vege'");
					while ($row = mysql_fetch_array($query)){
						...
						'<div class="fh5co-block to-animate"  style="background-image: url(images/'.$foto.')">
							...
							<div class="fh5co-text">
								...
								<p><a href="order.php?code='.$id.'" class="btn btn-primary">ORDER</a></p>
							</div>
						</div>';
					}
				?>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<ul class="social social-circle">
						...
						<li><a href="dessert.php"><i>3</i></a></li>
